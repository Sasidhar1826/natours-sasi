...
var _mapboxJs = require("../public/js/mapbox.js");
var _loginJs = require("../public/js/login.js");
var _updateSettingsJs = require("../public/js/updateSettings.js");
var _stripeJs = require("../public/js/stripe.js");
//Dom Elements
...
},{"../public/js/login.js":"7yHem","core-js/modules/web.immediate.js":"49tUX","core-js/modules/esnext.promise.try.js":"9Mfk9","../public/js/mapbox.js":"3zDlz","../public/js/updateSettings.js":"l3cGY","../public/js/stripe.js":"10tSC"}],"7yHem":[function(require,module,exports) {
...
const logout = async ()=>{
    try {
        const res = await (0, _axiosDefault.default).get("http://127.0.0.1:3000/api/v1/users/logout");
...
},{}],"9Mfk9":[function(require,module,exports) {
"use strict";
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const stripe = Stripe("pk_test_51Ow8asSEq49Iv6nu2HnctlSPSdUAt58Lq3xF4lPFhQRDK8MzcFMEtYlS0sii8sVeFtwdle36moAENUBD0R4n54Ey00lr3wcwjh");
const bookTour = async (tourId)=>{
    try {
        // 1) Get checkout session from API
        const session = await (0, _axiosDefault.default).get(`http://127.0.0.1:3000/api/v1/bookings/checkout-session/${tourId}`);
        // console.log(session);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}]},["8lqZg"], "8lqZg", "parcelRequire11c7")
